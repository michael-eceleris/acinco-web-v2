          ...
          <div className=' d-flex flex-wrap align-items-center my-7 '>
            <div className='col-12 col-lg-6 mb-5'>
              ...
              <Link
                ...
                to='/samsung-care-plus/electro/terminos-condiciones'
              >
                Leer más
                ...
                <div className='col-6 jarallax'>
                  <div className='bg-white shadow-xs rounded-xl p-4 mb-4 mb-2-xs bg-primary-soft-hover transition-bg-ease-150 text-decoration-none text-gray-800 h-100'>
                    ...
                    <p className='pt-3 text-justify'>
                      El Seguro te cubre el 80% del costo de la reparación o del
                      valor total del nuevo electrodoméstico en caso pérdida
                      total, sin que este supere el valor asegurado, por lo
                      tanto solo pagas el 20% del mismo
                    </p>
                  </div>
                </div>
                ...
                <div className='col-6 jarallax'>
                  <div className='bg-white shadow-xs rounded-xl p-4 mb-4 mb-2-xs bg-success-soft-hover transition-bg-ease-150 text-decoration-none text-gray-800 h-100'>
                    ...
                    <p className='text-justify hypens'>
                      ...
                      aseguradora, es decir, el recobro o el copago será
                      calculado sobre el valor de la reparación o el precio de
                      venta al momento de la indemnización según sea el caso.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className='col-6 jarallax'>
                  <div className='bg-white shadow-xs rounded-xl p-4 mb-4 mb-2-xs bg-primary-soft-hover transition-bg-ease-150 text-decoration-none text-gray-800 h-100'>
                    ...
                    <p className='text-justify'>
                      Reparaciones no realizadas por fuera de los centros
                      técnicos especializados avalados por el operador.
                    </p>
                  </div>
                </div>
