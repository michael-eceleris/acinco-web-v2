            ...
            <div className='col-12 col-lg-8'>
              <div className='bg-white p-5 p-4-xs rounded-xl article-format'>
                ...
                <p>
                  ...
                  una fractura/rotura producto de un accidente. Está dirigido a
                  todos los usuarios que adquieran su Protect my Phone en
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      ...
                      Protect My Phone por medio de las tiendas autorizadas.
                    </p>
                  </li>
                  <li>
                    <p>
                      No aplica para equipos a los cuales no se le haya
                      instalado el líquido de protección de la pantalla.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      Al momento de la compra de la tarjeta, la pantalla del
                      equipo móvil debe estar en buenas condiciones, no debe
                      tener ningún tipo de fractura o rotura.
                    </p>
                  </li>
                  <li>
                    <p>
                      El tiempo de carencia para esta asistencia es de 14 días.
                    </p>
                  </li>
                  <li>
                    <p>
                      La asistencia se realizará por medio de la reparación o
                      remplazo de la pantalla del equipo en los centros de
                      servicio técnicos autorizados por ACINCO S.A.S.
                    </p>
                  </li>
                  <li>
                    <p>
                      Si al momento de la reparación de la pantalla del equipo
                      este sobrepasa el valor de la tarjeta adquirida, el
                      excedente deberá ser asumido por el usuario.
                    </p>
                  </li>
                </ul>
                <h2
                ...
                <p>
                  La asistencia de fractura de pantalla es provista por ACINCO
                  S.A.S., el cual cubre la rotura accidental de pantalla por 12
                  (doce) meses a partir de la fecha de adquisición del Protect
                  My Phone.
                </p>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      Hurto total o parcial del bien asistido (hurto de sus
                      partes, de sus componentes o de sus periféricos).
                    </p>
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <p>Copia del documento del cliente ampliado al 150%.</p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      ...
                      ACINCO S.A.S. analizará los documentos y dará una
                      respuesta, si es preaprobado se enviará una orden de
                      reparación para que el equipo sea llevado a cualquier
                      punto Servientrega a nivel nacional para ser trasladado al
                      taller para su reparación o en su defecto en el lugar de
                      domicilio indicado por el cliente.
                    </p>
                  </li>
                </ul>
              </div>
