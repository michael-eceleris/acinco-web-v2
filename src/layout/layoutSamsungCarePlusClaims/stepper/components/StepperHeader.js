...
import { ReactComponent as DeviceInfo } from "../../../../assets/icons/devices.svg";
      ...
      <div className="container">
        ...
        <div className="show3">
          <div className="d-flex justify-content-around">
            ...
            <DivCircle
              style={{
                backgroundColor: currentStep >= 4 ? defaultColor : "#e1e1e1",
                color: currentStep >= 4 ? "#e1e1e1" : defaultColor,
              }}
            >
              5
            </DivCircle>
          ...
          <div className="mt-3 mb-0">
            ...
            >
              {currentStep === 0 && "1. Identifícate."}
              {currentStep === 1 && "2. Selecciona tu cobertura."}
              {currentStep === 2 && "3. Subir documentos. "}
              {currentStep === 3 && "4. Información adicional. "}
              {currentStep === 4 && "5. Enviar."}
            </p>
          </div>
        </div>
        <Stepper
        ...
        >
          ...
          <Step className="col-md-4 cursor-default min-h-150">
            <div className="m-0">
              <Send
                fill={currentStep >= 4 ? defaultColor : "#e1e1e1"}
                width="200"
                height="80"
                className="show2"
              />
              <p
                style={{ color: currentStep >= 4 ? defaultColor : "#bababa" }}
                className="mt--5 textcustom h6-xs"
              >
                5. Enviar
              </p>
