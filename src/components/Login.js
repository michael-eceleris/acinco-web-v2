    ...
    <>
      ...
      {error && !errorEmpty && !isLoading && handleClose ? (
        <div className="alert alert-danger">
          ...
          <p className="mb-0">
            Si el problema continúa comunícate en Bogotá 3905567, para el resto
      ...
      {errorUser === 500 && !isLoading && handleClose ? (
        <div className="alert alert-danger">
          ...
          Bogotá 3905567, para el resto de Colombia 01 8000 513 323 o WhatsApp
          +57 1 5142355
        </div>
      ) : null}
      ...
      {privacyPolicyPersonalData && (
        <p className="fs--12 mb-1 mt-1 text-center textcustom h6-xs mt-0">
          * Tus datos están protegidos mediante nuestra política de protección
          de datos, revisala{" "}
          <ButtonLink
