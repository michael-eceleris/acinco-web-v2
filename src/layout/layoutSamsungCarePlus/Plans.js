                  ...
                  <div className='card-body pl-0 pr-0 text-gray-600 justify-content-between ml-2'>
                    ...
                    <div className='h-75'>
                      ...
                      <ul>
                        ...
                        <li>
                          <p className='lead fs--18 text-justify'>
                            Falla mecánica o eléctrica fuera de garantía legal
                            por manipulación.
                          </p>
                        </li>
                        <li>
                        ...
                        <li>
                          <p className='lead fs--18 text-justify'>
                            Garantía básica extendida (A partir del mes 13).
                          </p>
                        </li>
                      </ul>
                      <p className='lead fs--18 text-justify'>
                        Cubre 2 reclamaciones anuales: 1 por daño físico o falla
                        mecánica y 1 por garantía básica extendida o cambio de
                        batería
                      </p>
                    </div>
                  </div>
                ...
                <div className='card p-4 b-0 h-100 flex-lg-row flex-md-column'>
                  ...
                  <div className='card-body pl-0 pr-0 text-gray-600 justify-content-between ml-2'>
                    ...
                    <div className='h-75'>
                      ...
                      <p className='lead fs--18 text-justify'>
                        Cubre 2 reclamaciones anuales: 1 por hurto o daño físico
                        o falla mecánica y 1 por garantía básica extendida o
                        cambio de batería
                      </p>
                    </div>
                  </div>
