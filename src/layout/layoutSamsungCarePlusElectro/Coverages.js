...
import RepairPhone from "../../assets/icons/fallamecanicaelectro.svg";
import Bandit from "../../assets/icons/bandit.svg";
import BanditSimple from "../../assets/icons/hurtosimpleelectro.svg";
import BrokenPhone from "../../assets/icons/danototalelectro.svg";
                ...
                <div className='card-body pl-0 pr-0 text-gray-600 justify-content-between'>
                  <div className='h-75'>
                    <p className='lead fs--18 text-justify'>
                      ...
                      y que este impida el funcionamiento de tu electrodoméstico
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className='card-body pl-0 pr-0 text-gray-600 justify-content-between'>
                    <div className='h-75'>
                      <p className='lead fs--18 text-justify'>
                        ...
                        original del electrodoméstico por un periodo
                        determinado.
                      </p>
                    </div>
                  </div>
              ...
              <div className='col-12 col-md-6 col-lg-4 mb-4'>
                <div className='card p-4 b-0 h-100 mt-1'>
                  ...
                  <div className='card-body pl-0 pr-0 text-gray-600 justify-content-between'>
                    <div className='h-75'>
                      <p className='lead fs--18 text-justify'>
                        Daño que impide el bien funcionamiento de la batería del
                        electrodoméstico.
                      </p>
                    </div>
                  </div>
