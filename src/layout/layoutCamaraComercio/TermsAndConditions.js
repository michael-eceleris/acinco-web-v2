      ...
      <section className="bg-white p-5">
        <div className="container">
          <h1 className="h2 text-center">
            Términos y Condiciones Asistencia Fractura de Pantalla – Cámara de
            Comercio Bogotá
          </h1>
        </div>
      </section>
            ...
            <div className="col-12 col-lg-8">
              <div className="bg-white p-5 p-4-xs rounded-xl article-format">
                <h2 id="plan" className="h4 text-primary font-weight-normal">
                  Asistencia Fractura de Pantalla – Cámara de Comercio Bogotá
                </h2>
                <p>
                ...
                <p>20% del valor de la pantalla.</p>
                <h2
                  id="seguro-pantalla"
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      Aplica únicamente para los clientes que adquieran o
                      renueven su registro mercantil por medio de cámara de
                      comercio de Bogotá.
                    </p>
                  </li>
                  <li>
                  ...
                  <li>
                    <p>
                      ...
                      un copago correspondiente al 20% del valor de la
                  ...
                  <li>
                    <p>El valor máximo de cobertura es hasta $1,800,000.</p>
                  </li>
                </ul>
                <h2
                  id="atencion-cliente"
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      En un máximo de 5 días hábiles de radicar la
                      documentación, Acinco analizará los documentos y dará una
                      respuesta, si es pre-aprobado se enviará una solicitud de
                      pago del copago y una orden de reparación para que el
                      equipo sea llevado a un punto logístico a nivel nacional
                      autorizado por Acinco, para ser trasladado al taller para
                      su reparación o en su defecto en el lugar de domicilio
