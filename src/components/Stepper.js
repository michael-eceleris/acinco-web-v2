...
import { ReactComponent as AndroidPhone } from "../assets/icons/AndroidPhone.svg";
      ...
      <div className=' col-xl-12 mb-3'>
        <div className='container'>
          <CustomH2
            ...
            className='ml-5 mb-1 h4-xs h2-md textcustom'
          >
          ...
          >
            ...
            <Step className='col-md-4 cursor-default min-h-150'>
              {pathname === "/samsung-care-plus/tramites-y-reclamaciones" ? (
                <div>
                  <AndroidPhone
