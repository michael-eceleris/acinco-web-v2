...
const ContactUs = () => {
  return ( 
    <section id="section_contact" className="mt-1 bg-light">
						...
						<div className="rounded bg-white shadow-xs d-flex">
							<div className="m-5 m-4-xs">
								...
								<form 	novalidate 
									...
									<input type="text" name="norobot" value="" className="hide" tabindex="-1"/> 
									<div id="ajax_dd_contact_response_container"></div>
									<div className="form-label-group mb-3">
										<input required placeholder="Name" id="contact_name" type="text" className="form-control form-control-pill"/>
										<label for="contact_name">Nombre</label>
									</div>
									<div className="form-label-group mb-3">
										<input required placeholder="Phone" id="contact_phone" type="text" className="form-control form-control-pill"/>
										<label for="contact_phone">Número de teléfono</label>
									</div>
									<div className="form-label-group mb-3">
										<input required placeholder="Email" id="contact_email" type="email" className="form-control form-control-pill"/>
										<label for="contact_email">Correo electrónico</label>
									</div>
									<div className="form-label-group mb-4">
										<textarea required placeholder="Message" id="contact_message" className="form-control rounded-xl" rows="3"></textarea>
										<label for="contact_message">Agrega tus comentarios</label>
									</div>
									<div className="clearfix bg-light position-relative rounded p-4 mb-4">
										<label className="form-checkbox form-checkbox-primary">
											...
											<i></i> 
											<span> 	
												Autorizo el uso de mis datos personales para recibir más información 
												<a href="page-terms-and-conditions.html" target="_blank"> Politica de privacidad</a>. 
											</span>
										</label>
									</div>
									<button type="submit" className="btn btn-secondary btn-pill btn-block">
										Enviar
									</button>
								</form>
							</div>
